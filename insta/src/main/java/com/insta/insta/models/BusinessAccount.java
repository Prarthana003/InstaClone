...
public class BusinessAccount extends Account implements BusinessAcc {
    public float bill;
    ...
    public void display() {
        System.out.println(this.company + " " + this.username + " " + this.UserId + " " + this.password + " " + this.password + " " + this.bill+this.posts);
        this.posts.dispay();
    }
